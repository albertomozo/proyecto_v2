                        ...
                        while($fila=mysqli_fetch_array($resultado)){  
                            ...
                            ?>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="<?php echo $key;?>" name="<?php echo $key;?>" id="<?php echo $key;?>"   value="<?php echo $valor;?>" onblur="config_privada('<?php echo $key;?>',document.getElementById('<?php echo $key;?>').value)" >
                                </div>
                              </div>
                              <?php
                        }
