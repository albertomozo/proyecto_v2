...
<body>
    ...
    $id = $_GET['peliId']; // validar y sanitizar
    ...
    <!-- Template Javascript -->
    <script src='http://<?php echo $_SERVER['HTTP_HOST']."$sitioRutaLocal/js/main.js";?>'></script>
    ...
    <script src='http://<?php echo $_SERVER['HTTP_HOST']."$sitioRutaLocal/js/pelicula_detalle.js";?>' ></script>
